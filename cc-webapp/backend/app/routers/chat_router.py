...
class ConnectionManager:
    ...
    async def broadcast_to_room(self, message: str, room_id: int):
        # ?¤ì œë¡œëŠ” room_idë³??°ê²° ê´€ë¦¬ê? ?„ìš”?˜ì?ë§??¬ê¸°?œëŠ” ?¨ìˆœ??
        ...
        try:
            while True:
                ...
                if message_data.get("type") == "message":
                    # ?¤ì‹œê°?ë©”ì‹œì§€ ë¸Œë¡œ?œìº?¤íŠ¸??send_message?ì„œ ì²˜ë¦¬
                    pass
