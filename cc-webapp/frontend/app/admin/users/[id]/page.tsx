...
const UserDetailPage = () => {
    ...
    const getRankColor = (rank?: string) => {
        if (!rank) return 'text-gray-400 bg-gray-400/10 border-gray-400/20';
        switch (rank) {
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-xl font-bold text-white">보상 지급</h3>
                            <button
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setRewardForm(prev => ({ ...prev, reward_type: e.target.value }))}
                                    className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white"
                                >
                                    <option value="BONUS">보너스 코인</option>
                                    <option value="GEMS">프리미엄 젬</option>
                                    <option value="CYBER_TOKENS">사이버 토큰</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setRewardForm(prev => ({ ...prev, amount: parseInt(e.target.value) || 0 }))}
                                    className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white"
                                    placeholder="보상 수량 입력"
                                />
                            </div>
                            ...
                            <div className="flex space-x-3 pt-4">
                                <button
                                    onClick={() => setShowRewardModal(false)}
                                    className="flex-1 bg-gray-600 hover:bg-gray-500 px-4 py-2 rounded-lg text-white transition-colors"
                                >
                                    취소
                                </button>
                                <button
